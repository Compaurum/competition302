...
class Player {
    ...
    public static void main(String args[]) {
        ...
        while (true) {
            ...
            if (endPoint != null && endPoint.x == KR && endPoint.y == KC){
                find = true;
                Cell temp = endPoint;
                endPoint = startPoint;
                startPoint = temp;
          ...
          /*  for (int i = 0; i < wasThereTable.length; i++) {
                for (int j = 0; j < wasThereTable[i].length; j++) {
                    System.err.print(wasThereTable[i][j]);
                }
                System.err.println();
            }*/
    ...
    public static void printAnswer(Cell cell, char[][] table){
        ...
        if (arrayList.size() > 0) {
            System.err.println(arrayList.get(0).x + "   " + arrayList.get(1).x);
            System.err.println(arrayList.get(0).y + "   " + arrayList.get(1).y);
            if (arrayList.get(0).y < arrayList.get(1).y)
